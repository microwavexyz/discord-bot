import { SlashCommandBuilder, ChatInputCommandInteraction, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, CacheType, PermissionFlagsBits, ComponentType, ButtonInteraction } from 'discord.js';
...
export const command: Command = {
  ...
  async execute(interaction: ChatInputCommandInteraction<CacheType>): Promise<void> {
    ...
    try {
      ...
      await interaction.reply({ content: 'There was an error fetching the ban list. Please try again later.', ephemeral: true });
    }
  },
};
